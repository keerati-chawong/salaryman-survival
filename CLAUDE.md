...
- **Promotion** (`scripts/Promotion.gd`, `scenes/Promotion.tscn`): recap screen between fights showing the next enemy's weakness/resistance chart, or the win screen after the final boss. Its "Go to shop" button reopens the Shop for another spend.
